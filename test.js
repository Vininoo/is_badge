...
test('isBadge(url)', async function (t) {
  ...
  await t.test('travis', () => {
    assert.equal(
      isBadge('https://travis-ci.org/drylikov/example.svg'),
      true,
      'ok: project'
    )

    assert.equal(
      isBadge('https://secure.travis-ci.org/drylikov/example.png'),
      true,
      'ok: secure'
    )

    assert.equal(
      isBadge('https://api.travis-ci.org/drylikov/example.png?branch=1.1.0'),
      true,
      'ok: api'
    )

    assert.equal(
      isBadge('https://travis-ci.org/drylikov/example.svg?branch=1.1.1'),
      true,
      'ok: branch'
    )

    assert.equal(
      isBadge('https://travis-ci.org/drylikov/example'),
      false,
  ...
  await t.test('inch-ci', () => {
    assert.equal(
      isBadge('https://inch-ci.org/github/drylikov/example.svg?branch=master'),
      true,
      'ok: w/ branch'
    )

    assert.equal(
      isBadge('https://inch-ci.org/github/drylikov/example.svg'),
      true,
      'ok: svg extension'
    )

    assert.equal(
      isBadge('https://inch-ci.org/github/drylikov/example.png'),
      true,
      'ok: png extension'
    )
    ...
    assert.equal(
      isBadge(
        'https://inch-ci.org/github/drylikov/example.svg?branch=master&style=shields'
      ),
      true,
    ...
    assert.equal(
      isBadge('https://inch-ci.org/github/drylikov/example'),
      false,
      'not ok: w/o extension'
    )
  })
  ...
  await t.test('codecov', () => {
    assert.equal(
      isBadge(
        'https://codecov.io/gh/drylikov/example/branch/master/graph/badge.svg'
      ),
      true,
      'ok: svg'
    )
    ...
    assert.equal(
      isBadge(
        'https://codecov.io/gh/drylikov/example/branch/master/graph/badge.png'
      ),
      false,
      'not ok: png'
    )
    ...
    assert.equal(
      isBadge('https://codecov.io/gh/drylikov/example/graph/badge.svg'),
      true,
      'ok: without branch'
    )

    assert.equal(
      isBadge('https://codecov.io/gh/drylikov/example/badge.svg'),
      true,
      'ok: without `graph`'
    )

    assert.equal(
      isBadge('https://codecov.io/gh/drylikov/badge.svg'),
      false,
